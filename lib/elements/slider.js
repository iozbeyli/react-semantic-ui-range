...
export default class Slider extends Component{
    ...
    setValue(value,triggeredByUser){
        ...
        if(this.props.settings.input) {
            $(this.props.settings.input).val(newValue);
        }
        if(this.props.settings.onChange) {
            this.props.settings.onChange(newValue, {triggeredByUser: triggeredByUser});
        }
        this.setState({
            value
        })
        ...
        return(
            <div>
                <div 
                    ...
                    >
                        <div ref={(inner) => {this.inner = inner}} style={styles.inner}>
                            <div style={
                                {...styles.track,
